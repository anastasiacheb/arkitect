...
export default function PreFooter({ section, title1, title2, link, button }) {
  return (
    <section className="bg-light rounded-b-4xl md:rounded-b-[60px] lg:rounded-b-[96px] text-center px-10 py-16 md:px-16 md:py-24 lg:py-48 lg:px-36">
      ...
      <p className="text-[40px] md:text-[64px] lg:text-[96px] font-medium leading-none pb-8 lg:pb-12 lg:leading-[1.1]">
        {title1} <br className="hidden lg:block lg:block" />
        {title2}
      </p>
      <Link
        href={link}
